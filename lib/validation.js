/**
 * Validation for Textarea Input Plugin
 *
 ...
 * @param {String|Bool} input.all.textarea - value of input textarea
 ...
 * @param {Object} [settings.all.textarea] - settings of input textarea {Object}
 *
 * @returns {Bool|String} true or a string with the text describing the error
 *
 * @module textareaValidation
 */

module.exports = function textareaValidation(input, settings) {
